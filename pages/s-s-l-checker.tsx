...
const SSLChecker: NextPage = () => {
  ...
  return (
    <>
      <div className="w-full relative bg-color h-[252.875rem] overflow-hidden text-left text-[2rem] text-black font-outfit-light-body-text-6">
        <div className="absolute top-[8rem] left-[0rem] w-[90rem] h-[32.938rem]" />
        <div className="absolute top-[27.625rem] left-[24.063rem] text-[0.875rem] text-grey-2">
          The SSL Checker Tool Enables you confirm the validity of an SSL
          certificate of any website.
        </div>
        ...
        <div className="absolute top-[215.5rem] left-[0rem] w-[90rem] h-[37.375rem] text-[1.125rem] text-primary">
        ...
        <div className="absolute top-[171.438rem] left-[calc(50%_-_720px)] w-[90rem] h-[37.813rem] text-color">
        ...
        <div className="absolute top-[107.25rem] left-[calc(50%_-_596px)] w-[74.563rem] overflow-hidden flex flex-col items-center justify-start gap-[3.125rem] text-center">
          ...
          <div className="flex flex-col items-start justify-start gap-[0.625rem] text-left text-[1.125rem]">
            <div className="w-[74.563rem] rounded-lg bg-color box-border h-[5.5rem] overflow-hidden shrink-0 flex flex-row items-start justify-start border-[1px] border-solid border-foundation-primary-blue-b50">
              <div className="self-stretch flex-1 flex flex-row items-center justify-between p-[1.875rem]">
                <div className="relative">What is an SSL certificate?</div>
                <img
            ...
            <div className="w-[74.563rem] rounded-lg bg-color box-border h-[5.5rem] overflow-hidden shrink-0 flex flex-row items-start justify-start border-[1px] border-solid border-foundation-primary-blue-b50">
              <div className="self-stretch flex-1 flex flex-row items-center justify-between p-[1.875rem]">
                <div className="relative">
                  How does the Ultahost SSL checker work?
                </div>
                <img
                  className="w-[1.5rem] relative h-[0.85rem] object-contain"
                  alt=""
            ...
            <div className="w-[74.563rem] rounded-lg bg-color box-border h-[5.5rem] overflow-hidden shrink-0 flex flex-row items-start justify-start border-[1px] border-solid border-foundation-primary-blue-b50">
              <div className="self-stretch flex-1 flex flex-row items-center justify-between p-[1.875rem]">
                <div className="relative">
                  What information does the Ultahost SSL check report provide?
                </div>
                <img
                  className="w-[1.5rem] relative h-[0.85rem] object-contain"
                  alt=""
            ...
            <div className="w-[74.563rem] rounded-lg bg-color box-border h-[5.5rem] overflow-hidden shrink-0 flex flex-row items-start justify-start border-[1px] border-solid border-foundation-primary-blue-b50">
              <div className="self-stretch flex-1 flex flex-row items-center justify-between p-[1.875rem]">
                <div className="relative">
                  How can I fix an SSL certificate issue?
                </div>
                <img
                  className="w-[1.5rem] relative h-[0.85rem] object-contain"
                  alt=""
            ...
            <div className="w-[74.563rem] rounded-lg bg-color box-border h-[5.5rem] overflow-hidden shrink-0 flex flex-row items-start justify-start border-[1px] border-solid border-foundation-primary-blue-b50">
              <div className="self-stretch flex-1 flex flex-row items-center justify-between p-[1.875rem]">
                <div className="relative">
                  Can I use the SSL checker tool for any website?
                </div>
                <img
                  className="w-[1.5rem] relative h-[0.85rem] object-contain"
                  alt=""
        ...
        <div className="absolute top-[79.688rem] left-[calc(50%_-_720px)] w-[90rem] h-[21.313rem] text-center text-color">
        ...
        <div className="absolute top-[43.813rem] left-[7.313rem] flex flex-col items-center justify-start gap-[2.125rem]">
          <div className="flex flex-col items-center justify-start">
            <div className="flex flex-row items-center justify-center p-[0.625rem]">
              <b className="relative">
                Website SSL Checker - Assess Your Site's Security
              </b>
            </div>
            <div className="flex flex-row items-center justify-center p-[0.625rem] text-center text-[1.25rem] text-grey-2">
              <div className="w-[45.313rem] relative font-light flex items-center justify-center shrink-0">
                Use our SSL checker to confirm SSL certificates fast. Boost
                website security, user trust, and SEO rankings.
              </div>
            </div>
          </div>
          <div className="flex flex-col items-start justify-start text-center text-[1.25rem] text-primary">
            <div className="flex flex-row items-start justify-start p-[0.625rem] gap-[4.812rem]">
                ...
                <div className="flex flex-col items-center justify-start">
                  ...
                  <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1rem] text-grey-2">
                    <div className="w-[20.25rem] relative font-light flex items-center justify-center shrink-0">
                      With our SSL Checker tool check SSL certificates validity,
                      encryption and issuer details for any domain instantly.
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center justify-start">
                ...
                <div className="flex flex-col items-center justify-start">
                  <div className="flex flex-row items-center justify-center p-[0.625rem]">
                    <div className="relative font-semibold">
                      Assure Security With SSL
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1rem] text-grey-2">
                    <div className="w-[20.25rem] relative font-light flex items-center justify-center shrink-0">
                      Keep your website secure by checking SSL certificates with
                      our SSL checker tool. Find and fix issues fast.
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center justify-start">
                ...
                <div className="flex flex-col items-center justify-start">
                  <div className="flex flex-row items-center justify-center p-[0.625rem]">
                    <div className="relative font-semibold">
                      Detailed SSL Insights
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1rem] text-grey-2">
                    <div className="w-[20.25rem] relative font-light flex items-center justify-center shrink-0">
                      Gain detailed insights into SSL certificates, including
                      expiration dates, domain validation status, and more, with
        ...
        <div className="absolute top-[15.938rem] left-[23.438rem] flex flex-col items-center justify-start gap-[1.437rem]">
          <div className="flex flex-col items-center justify-start">
            <div className="flex flex-row items-center justify-center p-[0.625rem]">
              <b className="relative">SSL Checker</b>
            </div>
            <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1.25rem] text-grey-2">
              <div className="relative font-light">
                Verify the presence of an SSL certificate on a website.
              </div>
            </div>
          </div>
          <div className="flex flex-row items-start justify-start py-[0rem] pr-[0rem] pl-[0.625rem] gap-[0.375rem] text-[0.875rem] text-grey-2">
            <div className="w-[33.188rem] rounded-9xs box-border flex flex-col items-start justify-center p-[0.875rem] border-[1px] border-solid border-primary">
              <div className="relative font-light">Enter website URL here</div>
            </div>
