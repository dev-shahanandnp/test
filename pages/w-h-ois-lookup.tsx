  ...
  return (
    <>
      <div className="w-full relative bg-color h-[252.875rem] overflow-hidden text-left text-[2rem] text-black font-outfit-light-body-text-6">
        ...
        <div className="absolute top-[27.625rem] left-[24.063rem] text-[0.875rem] font-medium">
          <span>Example: </span>
          <span className="text-primary">{`qq.com, google.co.in, bbc.co.uk, ebay.ca `}</span>
        </div>
        ...
        <div className="absolute w-[calc(100%_-_234px)] top-[47.188rem] right-[7.313rem] left-[7.313rem] flex flex-col items-center justify-start gap-[3.125rem]">
          <div className="flex flex-row items-center justify-center p-[0.625rem]">
            <b className="relative">
            ...
            <div className="flex flex-row items-start justify-start p-[0.625rem] gap-[4.812rem]">
                ...
                <div className="flex flex-col items-center justify-start">
                  <div className="flex flex-row items-center justify-center p-[0.625rem]">
                    <div className="relative font-semibold">
                      <p className="m-0">Check Domain</p>
                  ...
                  <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1rem] text-grey-2">
                    <div className="w-[20.25rem] relative font-light flex items-center shrink-0">
                      <span className="w-full">
                        <p className="m-0">Check whether a Domain Name is</p>
                        <p className="m-0">
                          available for registration or not via
                        </p>
                        <p className="m-0">our Domain Search Tool.</p>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center justify-start">
                ...
                <div className="flex flex-col items-center justify-start">
                  <div className="flex flex-row items-center justify-center p-[0.625rem]">
                    <div className="relative font-semibold">
                      <p className="m-0">Find Domain Owner</p>
                  ...
                  <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1rem] text-grey-2">
                    <div className="w-[20.25rem] relative font-light flex items-center shrink-0">
                      <span className="w-full">
                        <p className="m-0">Use the WHOIS Information tool</p>
                        <p className="m-0">to find out a domains owner,</p>
                        <p className="m-0">
                          location, ip and other information.
                        </p>
                      </span>
                    </div>
                  </div>
              ...
              <div className="flex flex-col items-center justify-start">
                ...
                <div className="flex flex-col items-center justify-start">
                  <div className="flex flex-row items-center justify-center p-[0.625rem]">
                    <div className="relative font-semibold">
                      <p className="m-0">Find Out Domain</p>
                  ...
                  <div className="flex flex-row items-center justify-center p-[0.625rem] text-[1rem] text-grey-2">
                    <div className="w-[20.25rem] relative font-light flex items-center shrink-0">
                      <span className="w-full">
                        <p className="m-0">Looking out for a domain name</p>
                        <p className="m-0">that you want to claim? Learn</p>
                        <p className="m-0">when a domain will expire with</p>
                        <p className="m-0">{`our whois & search tools.`}</p>
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="absolute top-[15.938rem] left-[23.438rem] flex flex-col items-center justify-start gap-[1.437rem]">
          <div className="flex flex-col items-center justify-start">
            <div className="flex flex-row items-center justify-center p-[0.625rem]">
              <b className="relative">
                <span>{`Whois `}</span>
                <span className="text-primary">Domain Lookup</span>
              </b>
            </div>
