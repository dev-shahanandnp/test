  ...
  return (
    <>
      <div className="w-full relative bg-color h-[532.875rem] overflow-hidden text-left text-[2rem] text-black font-outfit-light-body-text-6">
        ...
        <b className="absolute top-[61.75rem] left-[63.688rem]">{`Everest Turbo VPS `}</b>
        <div className="absolute top-[65rem] left-[6.813rem] w-[47.75rem] h-[31.5rem] text-[1.25rem]">
          ...
          <div className="absolute top-[14.563rem] left-[1.188rem] flex flex-col items-start justify-start gap-[0.937rem]">
            <div className="flex flex-row items-center justify-center p-[0.625rem]">
              <div className="relative">All Nepal Based VPS Plan Includes:</div>
            </div>
          ...
          <div className="absolute top-[2.375rem] left-[4.313rem] flex flex-col items-center justify-center p-[0.625rem] gap-[0.625rem]">
          ...
          <div className="absolute top-[2.344rem] left-[11.094rem] box-border w-[0.063rem] h-[7.875rem] border-r-[1px] border-solid border-grey-2" />
          <div className="absolute top-[2.375rem] left-[14.188rem] flex flex-col items-center justify-center p-[0.625rem] gap-[0.625rem]">
          ...
          <div className="absolute top-[2.344rem] left-[21.156rem] box-border w-[0.063rem] h-[7.875rem] border-r-[1px] border-solid border-grey-2" />
          <div className="absolute top-[2.375rem] left-[24.25rem] flex flex-col items-center justify-center p-[0.625rem] gap-[0.625rem]">
            <div className="relative font-medium">Storage</div>
            <b className="relative text-[2rem]">20</b>
            <div className="relative text-[1rem] font-light">GB</div>
          </div>
          <div className="absolute top-[2.344rem] left-[33.031rem] box-border w-[0.063rem] h-[7.875rem] border-r-[1px] border-solid border-grey-2" />
          <div className="absolute top-[2.375rem] left-[36.125rem] flex flex-col items-center justify-center p-[0.625rem] gap-[0.625rem]">
        ...
        <div className="absolute top-[64.813rem] left-[60.375rem] w-[22.938rem] h-[31.688rem] text-[0.875rem]">
        ...
        <div className="absolute top-[70.438rem] left-[7.938rem] bg-foundation-primary-blue-b50 w-[2.313rem] h-[2.438rem] overflow-hidden text-[1rem]">
          <div className="absolute top-[-9.25rem] left-[1.063rem] font-light flex items-center w-[4.5rem] h-[10rem]">
            +
          </div>
          <div className="absolute top-[0.438rem] left-[0.813rem] text-[1.25rem]">
            +
          </div>
        </div>
        <div className="absolute top-[70.438rem] left-[14.875rem] bg-foundation-primary-blue-b50 w-[2.313rem] h-[2.438rem] overflow-hidden text-[1rem]">
          <div className="absolute top-[-9.25rem] left-[1.063rem] font-light flex items-center w-[4.5rem] h-[10rem]">
            +
          </div>
          <div className="absolute top-[0.313rem] left-[0.875rem] text-[1.25rem]">
            -
          </div>
        </div>
      </div>
